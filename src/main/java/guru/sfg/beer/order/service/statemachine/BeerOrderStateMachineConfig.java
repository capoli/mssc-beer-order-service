...
//                .event(BeerOrderEventEnum.BEER_ORDER_DELIVERED)
//                .and().withExternal()
//                .source(BeerOrderStatusEnum.ALLOCATED).target(BeerOrderStatusEnum.DELIVERY_EXCEPTION)
//                .event(BeerOrderEventEnum.BEER_ORDER_FAILED);
    }
}
